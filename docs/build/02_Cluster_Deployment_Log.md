...
| Cert-Manager & ClusterIssuers | kc01 | Tier 3 (Certificates) | Active | Helm Deployment (Immediate Next Step) |  
| Microsoft Entra ID Integration | kc01 | Tier 4 (Identity & Access) | Active | OIDC / App Registration |  
| Portainer | kc01 | Tier 5 (Management) | Active | Deployed via Helm |  
| Vaultwarden | kc02 | Tier 5 (Applications) | In Progress | Password vault, backed by KeePass .kdbx |  
