### ARD 011: Automation and Scripting Standards
#### Status
Active
#### Context
...
5. **Directory Anchoring:** All scripts must anchor file paths dynamically to prevent Current Working Directory (CWD) execution failures. Every script must define and use:
